...
export async function fetchAllRegions() {
    const response = await fetch(`${BASE_URL}/crime/2023/6`);
...
export async function fetchMonthlyCrime(year, ward_code) {
    const response = await fetch(`${BASE_URL}/crime-location/${year}/${encodeURIComponent(ward_code)}`);
...
export async function fetchMonthlySentiment(year, ward_code) {
    const response = await fetch(`${BASE_URL}/sentiment-location/${year}/${encodeURIComponent(ward_code)}`);
...
export async function fetchWeeklyCrime(year, month, ward_code) {
    const response = await fetch(`${BASE_URL}/crime/${year}/${month}/${encodeURIComponent(ward_code)}/weekly`);
...
export async function fetchCrimeTotal(year, month, ward_code) {
    const response = await fetch(`${BASE_URL}/crime/${year}/${month}/${encodeURIComponent(ward_code)}`);
    if (!response.ok) throw new Error('Failed to fetch crime total');
    return await response.json();
}

export async function fetchSentimentTotal(year, month, ward_code) {
    const response = await fetch(`${BASE_URL}/sentiment/${year}/${month}/${encodeURIComponent(ward_code)}`);
...
export async function fetchCrimeReasons(year, month, ward_code) {
    const response = await fetch(`${BASE_URL}/crime-reasons/${year}/${month}/${encodeURIComponent(ward_code)}`);
...
export async function fetchWardLatLon(ward_code) {
    const response = await fetch(`${BASE_URL}/ward/latlon/${encodeURIComponent(ward_code)}`);
